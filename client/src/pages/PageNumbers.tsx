              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-24 px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-300"
                  />
                </div>
              </div>
        ...
        <div className="flex flex-col items-center gap-4 py-10 text-center">
          {isProcessing && (
            <>
              ...
              <p className="text-sm text-gray-500">Adding page numbers…</p>
            </>
          )}
          ...
          {isDone && (
            <>
              ...
              <p className="text-sm font-medium text-gray-900">Page numbers added!</p>
              <div className="flex gap-3">
                <a href={jobsApi.downloadUrl(jobId)}>
                  <Button>Download PDF</Button>
                </a>
                <Button variant="ghost" onClick={reset}>Number another</Button>
              </div>
            </>
          )}
